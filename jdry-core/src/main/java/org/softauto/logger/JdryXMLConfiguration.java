...
public class JdryXMLConfiguration extends XmlConfiguration{
    ...
    protected void doConfigure() {
        ...
        JdryAppender jdryAppender = JdryAppender.createAppender("tester",null,jdryLayout,false,null);
        //JdryAppender jdryAppender = JdryAppender.createAppender("tester",jdryFilter);
        //SocketAppender socketAppender = SocketAppender.createAppender("localhost", "5000", "TCP", null, 3000, "3000", "false", "sock", "false", "false", jdryLayout, null, "false",  config);
        appender.start();
        jdryAppender.start();
        ...
        addAppender(rolling );
        addAppender(jdryAppender );
        //addAppender(socketAppender );
        AppenderRef ref = AppenderRef.createAppenderRef("jdry", null, null);
        AppenderRef jdryRef = AppenderRef.createAppenderRef("tester", null, null);
        ...
        AppenderRef[] refs = new AppenderRef[] {ref,rollingRef,jdryRef};
        ...
        loggerConfig.addAppender(jdryAppender, Level.DEBUG, null);
