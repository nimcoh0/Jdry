...
public class EmbeddedHttpServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            //ResourceConfig config = new ResourceConfig(Greetings.class).register(AuthenticationFilter.class);
                    //.getProperties().put(new ResourceConfig().forApplicationClass(Greetings.class).forApplication(Greetings.class).PROPERTY_CONTAINER_REQUEST_FILTERS,
