...
public interface StepService {
  public static final org.apache.avro.Protocol PROTOCOL = org.apache.avro.Protocol.parse("{\"protocol\":\"StepService\",\"namespace\":\"tests.infrastructure\",\"version\":\"1.0\",\"types\":[{\"type\":\"external\",\"name\":\"BookCatalog\",\"namespace\":\"app.example.books\",\"fields\":[]},{\"type\":\"external\",\"name\":\"BookStore\",\"namespace\":\"app.example.books\",\"fields\":[]},{\"type\":\"external\",\"name\":\"Book\",\"namespace\":\"app.example.books\",\"fields\":[]},{\"type\":\"external\",\"name\":\"int\",\"fields\":[]},{\"type\":\"external\",\"name\":\"String\",\"namespace\":\"java.lang\",\"fields\":[]},{\"type\":\"external\",\"name\":\"Collection<app.example.books.Book>\",\"namespace\":\"java.util\",\"fields\":[]},{\"type\":\"external\",\"name\":\"List<app.example.books.Book>\",\"namespace\":\"java.util\",\"fields\":[]},{\"type\":\"external\",\"name\":\"Optional<app.example.books.Book>\",\"namespace\":\"java.util\",\"fields\":[]}],\"messages\":{\"app_example_books_BookStore_bookCatalog\":{\"method\":\"bookCatalog\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"variable\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"bookCatalog\",\"type\":\"app.example.books.BookCatalog\"}],\"response\":\"void\"},\"app_example_books_BookStore_addBook\":{\"method\":\"addBook\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"book\",\"type\":\"app.example.books.Book\"}],\"response\":\"app.example.books.BookStore\"},\"app_example_books_BookStore_getBookById\":{\"method\":\"getBookById\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"id\",\"type\":\"int\"}],\"response\":\"app.example.books.Book\"},\"app_example_books_BookStore_updateBook\":{\"method\":\"updateBook\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"book\",\"type\":\"app.example.books.Book\"},{\"name\":\"newTitle\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}],\"response\":\"app.example.books.BookStore\"},\"app_example_books_BookStore_addAllBooks\":{\"method\":\"addAllBooks\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"books\",\"type\":\"java.util.Collection<app.example.books.Book>\"}],\"response\":\"app.example.books.BookStore\"},\"app_example_books_BookStore_booksByAuthor\":{\"method\":\"booksByAuthor\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"author\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}],\"response\":\"java.util.List<app.example.books.Book>\"},\"app_example_books_BookStore_bookByTitle\":{\"method\":\"bookByTitle\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}],\"response\":\"java.util.Optional<app.example.books.Book>\"},\"app_example_books_BookStore_loopOverBooks\":{\"method\":\"loopOverBooks\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[],\"response\":\"void\"},\"app_example_books_BookStore_printBooks\":{\"method\":\"printBooks\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.BookStore\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.BookStore\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[{\"name\":\"books\",\"type\":\"java.util.List<app.example.books.Book>\"}],\"response\":\"void\"},\"app_example_books_Book_Book\":{\"method\":\"Book\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.Book\",\"type\":\"constructor\",\"class\":{\"fullClassName\":\"app.example.books.Book\",\"initialize\":\"INITIALIZE\"},\"request\":[{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"blabla\"},{\"name\":\"author\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"Nim\"}],\"response\":\"app.example.books.Book\"},\"app_example_books_Book_hello\":{\"method\":\"hello\",\"transceiver\":\"RPC\",\"namespace\":\"app.example.books.Book\",\"type\":\"method\",\"class\":{\"fullClassName\":\"app.example.books.Book\",\"initialize\":\"INITIALIZE_NO_PARAM\"},\"request\":[],\"response\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}}");
  /**
   */
   void app_example_books_BookStore_bookCatalog(app.example.books.BookCatalog bookCatalog);
  /**
   */
   app.example.books.BookStore app_example_books_BookStore_addBook(app.example.books.Book book);
  /**
   */
   app.example.books.Book app_example_books_BookStore_getBookById(int id);
  /**
   */
  ...
  /**
   */
   void app_example_books_BookStore_printBooks(java.util.List<app.example.books.Book> books);
  /**
   */
  ...
  public interface Callback extends StepService {
     ...
     */
    void app_example_books_BookStore_bookCatalog(app.example.books.BookCatalog bookCatalog, org.softauto.serializer.CallFuture<Void> callback) throws java.io.IOException;
    /**
     * @throws java.io.IOException The async call could not be completed.
     */
     ...
     * @throws java.io.IOException The async call could not be completed.
     */
    void app_example_books_BookStore_getBookById(int id, org.softauto.serializer.CallFuture<app.example.books.Book> callback) throws java.io.IOException;
    /**
     * @throws java.io.IOException The async call could not be completed.
     */
     ...
     * @throws java.io.IOException The async call could not be completed.
     */
    void app_example_books_BookStore_printBooks(java.util.List<app.example.books.Book> books, org.softauto.serializer.CallFuture<Void> callback) throws java.io.IOException;
    /**
     * @throws java.io.IOException The async call could not be completed.
     */
