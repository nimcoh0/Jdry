...
public void validate(String exp0,String operator0,Object expected0)throws Exception{
  ...
  /**
   */
 public  baeldung.cucumber.books.Book  addBook_book  ;
 
@When("got addBook2 result")
public  java.lang.Object[] baeldung_cucumber_books_BookCatalog_addBook_result(){
...
@ParameterType(".*")
public baeldung.cucumber.books.Book book1 (String book1)throws Exception{
if(Utils.isJson(book1)){
      return new ObjectMapper().readValue(book1, baeldung.cucumber.books.Book.class);
}
      ExpressionParser parser = new SpelExpressionParser();
...
public baeldung.cucumber.books.Book book1Value;
...
public  java.lang.Object[] baeldung_cucumber_books_BookCatalog_addBook(String exps0 ,String values0){
AtomicReference<Object[]> ref = new AtomicReference();
try {
    CountDownLatch lock = new CountDownLatch(1);
    new ListenerServiceImpl() {
        @Override
        public java.lang.Object[] baeldung_cucumber_books_BookCatalog_addBook(baeldung.cucumber.books.Book book1 ) {
        book1Value = book1;
